...
function AnalysisLoadingContent() {
	...
	return (
		<div className="fixed inset-0 bg-gradient-to-br from-blue-50 via-background to-purple-50 dark:from-blue-950/20 dark:via-background dark:to-purple-950/20 flex items-center justify-center p-4">
			<div className="max-w-2xl w-full space-y-8">
				...
				<div className="text-center space-y-4">
					...
					<h1 className="text-3xl font-bold text-foreground">AI 포트폴리오 분석</h1>
				...
				<div className="space-y-4">
					<div className="flex justify-between items-center">
						<span className="text-sm font-medium text-foreground">분석 진행률</span>
				...
				{isCompleted && (
					<div className="bg-card rounded-2xl p-8 shadow-lg border border-green-200 dark:border-green-800">
						<div className="text-center space-y-4">
							...
							<h3 className="text-xl font-bold text-green-900 dark:text-green-100">분석 완료!</h3>
							...
							<div key={step.id} className="text-center space-y-2">
								<div
									className={`w-12 h-12 mx-auto rounded-full flex items-center justify-center transition-all duration-300 ${
										isActive ? "bg-blue-500 text-white scale-110" : isStepCompleted ? "bg-green-500 text-white" : "bg-muted text-muted-foreground"
									}`}
								>
